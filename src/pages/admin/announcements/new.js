...
import { validateUrl, required, url, futureDate } from '../../../utils/validation';
...
const NewAnnouncementPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.media.image) {
      const imageValidation = validateUrl(formData.media.image);
      if (!imageValidation.isValid) {
        toast.error(`Image URL: ${imageValidation.message}`);
        return;
      }
    }
  ...
  return (
    <AdminLayout>
      <Head>
        <title>Create Announcement | Arsa Nexus Admin</title>
        <meta name="description" content="Create a new website announcement" />
      </Head>
        ...
        >
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-300">Create a new announcement to display on your website</p>
            </div>
          </div>
        </motion.div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <ValidatedInput
                  ...
                  onChange={(e) => handleInputChange('actionButton.text', e.target.value)}
                  className="dark bg-white/10"
                ...
                <ValidatedInput
                  ...
                  onChange={(e) => handleInputChange('actionButton.link', e.target.value)}
                  validation={[url()]}
                  className="dark bg-white/10"
                ...
                <ValidatedInput
                  ...
                  label="Button Color"
                  value={formData.actionButton.color}
                  onChange={(e) => handleInputChange('actionButton.color', e.target.value)}
                  className="dark bg-white/10"
                />
              </div>
            </div>
