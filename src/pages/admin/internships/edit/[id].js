...
const EditInternshipPage = () => {
  ...
  const fetchInternship = async () => {
    try {
      ...
      if (data.success || data.internship) {
        const internshipData = data.internship || data.data;
        ...
        setFormData({
          ...
          locationType: internshipData.locationType || 'Remote',
          level: internshipData.level || 'Entry Level',
          duration: internshipData.duration || '',
          stipend: {
            amount: internshipData.stipend?.amount || '',
            period: internshipData.stipend?.period || 'Month',
            type: internshipData.stipend?.type || 'Paid'
          },
          applicationDeadline: internshipData.applicationDeadline ?
            new Date(internshipData.applicationDeadline).toISOString().split('T')[0] : '',
          ...
          contactInfo: {
            email: internshipData.contactInfo?.email || '',
            phone: internshipData.contactInfo?.phone || '',
            website: internshipData.contactInfo?.website || ''
          },
          companyInfo: {
            name: internshipData.companyInfo?.name || '',
            size: internshipData.companyInfo?.size || '',
            industry: internshipData.companyInfo?.industry || '',
            description: internshipData.companyInfo?.description || '',
            logo: internshipData.companyInfo?.logo || '',
            website: internshipData.companyInfo?.website || ''
          },
          applicationProcess: internshipData.applicationProcess || '',
          featured: internshipData.featured || false,
          urgent: internshipData.urgent || false,
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.stipend.amount) {
      const amountValidation = validateNumber(formData.stipend.amount, 0);
      if (!amountValidation.isValid) {
        toast.error(`Stipend Amount: ${amountValidation.message}`);
        return;
      }
    }
      ...
      <AdminLayout>
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-white text-lg">Loading internship data...</p>
          </div>
        </div>
      </AdminLayout>
    );
  ...
  return (
    <AdminLayout>
      <Head>
        <title>Edit Internship | Arsa Nexus Admin</title>
        <meta name="description" content="Edit internship opportunity" />
      </Head>
        ...
        >
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-300">Update internship opportunity details</p>
            </div>
          </div>
        </motion.div>
            ...
            <div>
              ...
              <div className="mt-6">
                <ValidatedInput
                  ...
                  rows={6}
                  className="dark bg-white/10"
                  placeholder="Describe the internship role, responsibilities, and what you're looking for in a candidate..."
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <ValidatedInput
                  ...
                  options={stipendPeriods.map(period => ({ value: period, label: period }))}
                  className="dark bg-white/10"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-6">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-white">Featured Internship</span>
                </label>
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    type="checkbox"
